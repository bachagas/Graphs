...
public class Game extends Graph {
	...
	public Game( boolean populateGraphMap ) {
		...
		int[][] board = new int[Node.BOARD_SIZE][Node.BOARD_SIZE];
		...
		/*
		 * TODO
		 * Criar todos os nós (9!) - permutações de 9 números
		 * Criar as relações deles no map
		 */
	}
